...
DMV_gesso_valle_confluenza = 0.33 * 3.057

DMV_gesso_conf_stura = 0.33 * 4.762
...
Q_Italgen_irr = Q_consortia_Italgen_Gesso_eff_d["Q Naviglio"]
...
Q_res_nodo_1 = Q_disp_nodo_1 - Q_Italgen_irr - Q_consortia_Italgen_Gesso_eff_d["Q Bedale"] - Q_Italgen_Gesso_idro
Q_disp_nodo_2 = Q_res_nodo_1 - DMV_gesso_Italgen
Q_Madonna_Bruna = Q_consortia_Italgen_Gesso_eff_d["Q Madonna Bruna"]
Q_res_nodo_2 = Q_disp_nodo_2 - Q_Madonna_Bruna + DMV_gesso_Italgen
...
Q_res_nodo_4 = Q_disp_nodo_3 - Q_Sinistra_Gesso + DMV_gesso_Italgen

Q_gesso_residuo_confluenza = Q_res_nodo_4
...
Q_disp_nodo_8 = Q_res_nodo_7 - Q_inf_1 + Q_eden
...
if Q_disp_VG >= Q_VG_conc:
    ...
    # Gs_NV = 1
elif (Q_disp_VG > 0) and (Q_disp_VG < Q_NV_conc):
    Q_VG_eff = Q_disp_VG
    fattore_riparto_NV = Q_NV_eff/Q_NV_conc
    # Gs_NV = Q_NV_eff/Q_NV_conc
else:
...
Q_g_valle_gesso_eff_d.update((consortium, Q * fattore_riparto_2) for consortium, Q in Q_g_valle_gesso_eff_d.items())
Q_g_valle_gesso_eff_l = [x for x in Q_g_valle_gesso_eff_d.values()]
Q_g_valle_gesso_eff_a = np.array(Q_g_valle_gesso_eff_l)
Q_g_valle_gesso_eff_totale = float(np.sum(Q_Nav_Ver_eff_a))

Q_res_nodo_8 = Q_disp_nodo_8 - Q_g_valle_gesso_eff_totale + DMV_gesso_valle_confluenza

#Bealera Maestra

Q_disp_nodo_9 = Q_res_nodo_8- Q_inf_2 + Q_dep
...
Q_res_nodo_9 = Q_disp_nodo_9 - Q_BM_eff
